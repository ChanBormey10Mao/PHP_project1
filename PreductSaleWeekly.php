...
<body>
    ...
    function RetrieveDataDB($conn)
    {
        ...
        DATE_ADD(sale.sale_date, INTERVAL(1-DAYOFWEEK(sale.sale_date)) DAY) as start_date,
        DATE_ADD(sale.sale_date, INTERVAL(7-DAYOFWEEK(sale.sale_date)) DAY) as end_date, 
